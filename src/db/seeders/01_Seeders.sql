...
INSERT INTO "Users" ("id", "email", "password", "role", "linkedGateId", "token", "createdAt", "updatedAt") VALUES
                                                                                                               ('b1b19876-bff4-42cd-90ae-0e497ff50c99', 'admin@example.com', 'hashed_password1', 'admin', NULL, , now(), now()),
                                                                                                               ('fa4d116f-7b3f-4c9d-88d6-8f01b36dc8c6', 'user@example.com', 'hashed_password2', 'user', NULL, , now(), now()),
